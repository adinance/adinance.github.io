    ...
    var _t = function (t, e) {
        ...
        $t = function (t, e) {
            !(function (t, e) {
                ...
                (function (t, e) {
                    ...
                    n &&
                        (e.imageUrl
                            ? (lt(n, ""), n.setAttribute("src", e.imageUrl), n.setAttribute("alt", e.imageAlt || ""), st(n, "width", e.imageWidth), st(n, "height", e.imageHeight), (n.className = C.image), nt(n, e, "image"))
                            : dt(n));
                })(0, e),
                (function (t, e) {
                    var n = V();
        ...
        ne = function (t, e, n) {
            t &&
                (e.isComposing ||
                    229 === e.keyCode ||
                    (t.stopKeydownPropagation && e.stopPropagation(), "Enter" === e.key ? oe(e, t) : "Tab" === e.key ? ie(e) : [].concat(te, ee).includes(e.key) ? re(e.key) : "Escape" === e.key && ae(e, t, n)));
        },
        oe = function (t, e) {
