  ...
  <div class="main-wrapper">
    ...
    <nav class="navbar3">
      ...
      <div class="brand-and-icon">
        <a href="<?php echo BASE_URL;?>index.php/Home"><img src="<?php echo BASE_URL; ?>assets/images/cmo-white-164x62.png" /></a>
      ...
      <div class="navbar3-collapse">
        <ul class="navbar3-nav">
          <li>
            ...
            <div class="sub-menu w3-animate-opacity">
              ...
              <div class="sub-menu-item"><br>
                ...
                <ul>
                  <li><a href="<?php echo BASE_URL;?>index.php/About" style="font-weight: bold;">Who We Are</a></li>
          ...
          <li>
            <a href="<?php echo BASE_URL;?>index.php/Work">WORKS</a>
          </li>
          <li>
