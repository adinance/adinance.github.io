...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    ?>
    <tr>
        <td align="left" class="tb-border1" style="padding: 5px;" title="<?=$v['description_en']?>"><?=$v['title_en']?></td>
        <td align="center" class="tb-border2" style="padding: 5px;"><a href="uploads/financial-stagement/<?=$v['file_en']?>" target="_blank"><img src="../image/ir/btn-download-pdf.png" /></a></td>
    </tr>
    <? 
    }
    ?>
