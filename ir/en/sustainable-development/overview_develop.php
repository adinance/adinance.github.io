<div id="hdr_main">Sustainability - Overview</div>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tbody>
        ...
        <tr class="head-tb">
            ...
            <td width="100" align="center" class="tb-border3" bgcolor="#e7e7e8" style="padding: 5px;">Overview</td>
        </tr>
        <tr>
            <td align="center" class="tb-border1" style="padding: 5px;">1</td>
            <td align="center" class="tb-border3" style="padding: 5px;"><a href="uploads/sustainable-development/overview-en-dev.pdf" target="_blank"><img src="../image/ir/btn-download-pdf.png" /></td>
        </tr>
