...
<div id="ir-corp-content-box" style="border:0;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr style="background-color:#e7e7e8; padding:0px 5px; font-weight:bold; ">
            ...
            <td width="277" class="ir-td2" style="font-size: 12px;">หัวข้อ</td>
            <td width="10" align="center" class="ir-td3" style="font-size: 12px;">วันที่
        ...
        <tr>
            ...
            <!-- <td class="td2"><a href="uploads/press-release/<?=$v['file_th']?>" target="_blank"><?=$v['title_th']?></a></td> -->
            <td class="td2"><a href="/ir/index.php?lang=th&mod=news-room&menu=press-release-preview&id=<?=$v['id']?>"><?=$v['title_th']?></a></td>
            <td align="center" class="td3"><?=$v['create_dated']?>
            </td>
        </tr>
        <? 
        }
