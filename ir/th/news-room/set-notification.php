<div id="hdr_main">ข่าวแจ้งตลาดหลักทรัพย์</div>
<?php
$configurationId = 5;
...
$arrList = getIRDocumentPagingList($condition,$order, $startpoint, $perpage);
...
<div id="ir-corp-content-box" style="border:0;">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td class="td2"><a href="uploads/set-notification/<?php echo $v['file_th']?>" target="_blank"><?php echo $v['title_th']?></a></td>
