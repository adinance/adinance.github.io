<div id="hdr_main">รายงานประจำปี</div>
<?php
$configurationId = 4;
$order = " year desc ";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr class="head-tb">
        <td height="20" align="left" class="tb-border1" valign="middle" bgcolor="#000000" colspan="4" style="padding: 5px;">
            <span style="color: rgb(255, 255, 255); font-size: 14px;font-weight: bold; background-color: rgb(35, 31, 32);">ปี : 2551 - <?php echo @date("Y")+543-1?></span>
        </td>
    </tr>
    <tr class="head-tb">
    ...
    <tr>
        ...
        <td align="center" class="tb-border2" style="padding: 5px;"><a href="uploads/annual-report/<?php echo $v['file_th']?>" target="_blank"><img src="../image/ir/btn-download-pdf.png" /></a></td>
    </tr>
    <?php 
    }
    ?>
