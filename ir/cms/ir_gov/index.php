...
// Call getCorpGovlist
$mList = getCorpGovList($cond ,$order,$startpoint,$perpage);

$arrDetail = getGovDesc();
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : Investor Retations -&gt;  Corporate Governmance</b>
      </td>
    ...
    <tr>
      <td colspan="2" align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 20px 20px; color:#666;"><b>Corporate Governmance</b> : Description and PDF File</td>
    </tr>
    <tr>
      <td colspan="2" align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 20px 20px; color:#666;">
      <form action="add_desc_script.php" method="post" enctype="multipart/form-data" name="formAddDesc" id="formAddDesc">
      <div id="form-add-area" style="width:400px;">
     <p><label><b>Description</b></label>
     </p>
     <p>
       <textarea name="detail"  id="detail" style="width:380px; height:80px;" ><?=stripslashes($arrDetail[detail])?></textarea>
       <input type="hidden" name="detailval" id="detailval">
     </p>
     <p><b>PDF File</b>*</p>
      <p><a href = "../../data/irfile/gov/pdf/<?=$arrDetail[pdf]?>" target="_blank"><?=$arrDetail[pdf]?></a></p>
      <p><input type="file" name="pdf" id="pdf"><input name="old_pdf" type="hidden" id="old_pdf" value="<?=$arrDetail[pdf]?>"></p>
       <div id="add-button" >Save</div>
     </div>
      </form></td>
    </tr>
    <tr>
      <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px"><b>Corporate Governmance</b> : Article</td>
      <td align="right" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">&nbsp;</td>
    </tr>
    <tr>
      <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All (<?php echo sumGov(''); ?>) | Active (<?php echo sumGov('1'); ?>) | inactive (<?php echo sumGov('2'); ?>)</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" class="txt-content-11-black" style="padding: 20px">
      <form name="form1" method="post" action="delete_script.php" onSubmit="return confirm('Confirm to delete?'); ">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr bgcolor="<?=$cms_bghead?>" >
            ...
            <td  class="txt-content-11-white-2">Title</td>
      ...
      <br><br>
      <?php echo Pages("main_ir_gov",$perpage,"index.php?perpage=$perpage&",$cond); ?>
      </td>
  </tr>
  </table>	   
</div>
