...
$arrDetail = getNewsletterDetail(" WHERE id = '$id' ");
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : News &amp; Activities-&gt; <a href="index.php">PR Clips</a> -> Edit</b>
      </td>
  ...
  <tr>
    ...
    <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     ...
     <p><img src="../../data/newsletter/photo/<?=$arrDetail[photo]?>">
      ...
      <p><b>Photo Thumbnail * ( 75X100 px)</b></p>
       <p><img src="../../data/newsletter/thumb/<?=$arrDetail[thumb]?>">
        <input name="old_file2" type="hidden" id="old_file2" value="<?=$arrDetail[thumb]?>">
      </p>
      <p><input name="file2" type="file" id="file2"></p>
      <p><b>URL</b> *</p>
      <!--<p><a href="../../data/newsletter/pdf/<?=$arrDetail[pdf]?>" target="_blank"><?=$arrDetail[pdf]?></a></p>-->
      <!--<p><a href="<?=$arrDetail[pdf]?>" target="_blank"><?=$arrDetail[pdf]?></a></p>-->
<!--        <input name="old_file3" type="hidden" id="old_file3" value="<?=$arrDetail[pdf]?>">-->
<!--      <p><input name="file3" type="file"  id="file3"></p>-->
      <p><input name="url" type="text" value="<?=$arrDetail[pdf]?>" ></p>
