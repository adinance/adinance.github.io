...
$arrDetail = getCareerDetail(" WHERE id = '$id' ");
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : <a href="index.phpindex.php">Career</a> -> Edit</b>
      </td>
  ...
  <tr>
    ...
    <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     ...
     <p>
       <textarea name="detail" class="FCKeditor" id="detail" ><?=stripslashes($arrDetail[detail])?></textarea>
     </p>
