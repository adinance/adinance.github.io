...
$keyword = " WHERE title LIKE'%$keyword%' OR detail LIKE %$keyword%'  ";
}
// Paginate
...
// Call getCareerlist
$mList = getCareerList($cond ,$order,$startpoint,$perpage);
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : Career</b>
      </td>
    ...
    <tr>
      <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All (<?php echo sumCareer(''); ?>) | Active (<?php echo sumCareer('1'); ?>) | inactive (<?php echo sumCareer('2'); ?>)</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" class="txt-content-11-black" style="padding: 20px">
      <form name="form1" method="post" action="delete_script.php" onSubmit="return confirm('Confirm to delete?'); ">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr bgcolor="<?=$cms_bghead?>" >
            ...
            <td width="30%" class="txt-content-11-white-2">Title</td>
            <td  class="txt-content-11-white-2">Detail</td>
		...
		?>
         <li id="recordsArray_<?=$value[id]?>">
          ...
          <tr class="txt-content-11-black-2" bgcolor="<?=$cms_bgout?>" onMouseOver="this.style.backgroundColor='<?=$cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?=$cms_bgout?>'" >
            ...
            <td width="30%" valign="top" class="txt-content-11-black-2">
      ...
      <br><br>
      <?php echo Pages("main_career",$perpage,"index.php?perpage=$perpage&",$cond); ?>
      </td>
  </tr>
  </table>	   
</div>
