...
$cond = " WHERE title LIKE '%$keyword%'  OR description LIKE '%$keyword%'  OR detail LIKE '%$keyword%'   ";
}
// Paginate
...
// Call getActivitieslist
$mList = getNewsList($cond ,$order,$startpoint,$perpage);
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : News &amp; Activities-&gt; News</b>
      </td>
    ...
    <tr>
      <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All (<?php echo sumNews(''); ?>) | Active (<?php echo sumNews('1'); ?>) | inactive (<?php echo sumNews('2'); ?>)</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" class="txt-content-11-black" style="padding: 20px">
		...
		?>
         <li id="recordsArray_<?=$value[id]?>">
          ...
          <tr class="txt-content-11-black-2" bgcolor="<?=$cms_bgout?>" onMouseOver="this.style.backgroundColor='<?=$cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?=$cms_bgout?>'" >
            ...
            <?php if($value[photo]!=""){ ?>
            <img src="../../data/news/thumb/<?=$value[photo]?>" border="0">
            <?php }else{ ?>
            <a href="view.php?id=<?=$value[id]?>">view</a>
            <?php } ?>
            </td>
            <td width="20%" valign="top" class="txt-content-11-black-2"><?=stripslashes($value[title])?></td>
            <td valign="top" class="txt-content-11-black-2">
			<?=stripslashes($value[description])?> 
            </td>
      ...
      <br><br>
      <?php echo Pages("main_news",$perpage,"index.php?perpage=$perpage&",$cond); ?>
      </td>
  </tr>
  </table>	   
</div>
