...
$arrDetail = getNewsDetail(" WHERE id = '$id' ");
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : News &amp; Activities-&gt; <a href="index.php">News</a> -> Edit</b>
      </td>
  ...
  <tr>
    ...
    <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     ...
     <p>
      ...
      <p><img src="../../data/news/thumb/<?=$arrDetail[photo]?>">
        <input name="photo" type="hidden" id="photo" value="<?=$arrDetail[photo]?>">
      </p>
      <p><input type="file" name="photo" id="photo"></p>
      
      
      <p><b>Thumbnail 1 ( 200 X 210 px)</b></p>
      <p><img src="../../data/news/thumb/<?=$arrDetail[thumbnail_1]?>">
      ...
      <p><b>Thumbnail 2 ( 200 X 210 px)</b></p>
      <p><img src="../../data/news/thumb/<?=$arrDetail[thumbnail_2]?>">
     ...
     <p>
      <input name="news_date" id="news_date" type="text" class="form-input" value="<?=$arrDetail[news_date]?>">
     </p>
