...
var numericExpression = /^[0-9]+$/;
  ...
  $().ready(function () {
	 ...
	 $("#add-button").click(function(){
		...
		if (logo.val()=='') {
			logo.addClass('hightlight');
			logo.focus();
			return false;
		} else logo.removeClass('hightlight');
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : <a href="index.php">Our Family</a> -> Add New</b>
      </td>
    ...
    <form action="add_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     ...
     <p>
      ...
      <select name="type_id" class="form-search" id="type_id">
          ...
          <option value="1" <?php if($type_id==1){?> selected <?php } ?> >EVENT MANAGEMENT</option>
          <option value="2" <?php if($type_id==2){?> selected <?php } ?>>EVENT SUPPLY</option>
        </select>
     </p>
      <p>
      <label>Name*</label> 
     ...
     <p>
       <textarea name="detail" rows="8" class="form-textarea" id="detail" style="background-color:#FFF;"></textarea>
     ...
     <p><b>Logo</b>*</p>
      ...
      <p>
        <label>URL</label> </p>
     <p>
      <input name="url" id="url" type="text" class="form-input">
     </p>
