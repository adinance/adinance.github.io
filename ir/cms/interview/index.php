...
// Call getInterviewlist
$mList = getInterviewList($cond ,$order,$startpoint,$perpage);
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : News &amp; Activities-&gt; Interview</b>
      </td>
    ...
    <tr>
      <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All (<?=sumInterview('')?>) | Active (<?=sumInterview('1')?>) | inactive (<?=sumInterview('2')?>)</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" class="txt-content-11-black" style="padding: 20px">
		...
		?>
         <li id="recordsArray_<?=$value[id]?>">
          ...
          <tr class="txt-content-11-black-2" bgcolor="<?=$cms_bgout?>" onMouseOver="this.style.backgroundColor='<?=$cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?=$cms_bgout?>'" >
            ...
            <?php if($value[thumb]!=""){ ?>
            <a href="../../data/interview/photo/<?=$value[photo]?>" target="_blank"><img src="../../data/interview/thumb/<?=$value[thumb]?>" border="0"></a>
            <?php } ?>
            
            </td>
            <td width="20%" valign="top" class="txt-content-11-black-2"><?=$value[title]?></td>
            <td valign="top" class="txt-content-11-black-2">
			<a href="../../data/interview/pdf/<?=$value[pdf]?>" target="_blank"><?=$value[pdf]?></a>
            </td>
      ...
      <br><br>
      <?php echo Pages("main_interview",$perpage,"index.php?perpage=$perpage&",$cond); ?>
      </td>
  </tr>
  </table>	   
</div>
