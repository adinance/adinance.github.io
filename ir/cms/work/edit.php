...
$arrDetail = getWorkDetail(" WHERE id = '$id' ");
?>
  ...
  <tr>
    ...
    <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     ...
     <p>
      ...
      <p><img src="../../data/work/<?=$arrDetail[photo]?>">
        <input name="old_photo" type="hidden" id="old_photo" value="<?=$arrDetail[photo]?>">
      </p>
      <p><input type="file" name="photo" id="photo"></p>
      <p><label><b>Video ID</b>* ( youtube ex. http://www.youtube.com/watch?v=<b><span style="color:#900;">kcuybpODePE</span></b> )</label> </p>
     <p>
      <input name="code" id="code" type="text" class="form-input" value="<?=stripslashes($arrDetail[code])?>">
     </p>
