...
// Call getWorklist
$mList = getWorkList($cond ,$order,$startpoint,$perpage);
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : Our Work</b>
      </td>
    ...
    <tr>
      <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All (<?php echo sumWork(''); ?>) | Active (<?php echo sumWork('1'); ?>) | inactive (<?php echo sumWork('2'); ?>)</td>
      ...
      <form name="form1" method="post" action="delete_script.php" onSubmit="return confirm('Confirm to delete?'); ">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr bgcolor="<?=$cms_bghead?>" >
            ...
            <td width="20%" class="txt-content-11-white-2">Youtube Video ID</td>
		...
		?>
         <li id="recordsArray_<?=$value[id]?>">
          ...
          <tr class="txt-content-11-black-2" bgcolor="<?=$cms_bgout?>" onMouseOver="this.style.backgroundColor='<?=$cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?=$cms_bgout?>'" >
            ...
            <td width="20%" valign="top" class="txt-content-11-black-2">
            <iframe class="youtube-player" type="text/html" width="200" height="140" src="http://www.youtube.com/embed/<?=stripslashes($value[code])?>" frameborder="0">
</iframe>
            <br>
<a href="http://www.youtube.com/watch?v=<?=stripslashes($value[code])?>" target="blank"><?=stripslashes($value[code])?></a></td>
            <td valign="top" class="txt-content-11-black-2">
			<img src="../../data/work/<?=$value[photo]?> ">
            </td>
      ...
      <br><br>
      <?php echo Pages("main_work",$perpage,"index.php?perpage=$perpage&",$cond); ?>
      </td>
  </tr>
  </table>	   
</div>
