...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b>News Room &gt; <a href="index.php">Press Release</a> > Add New</b></td>
    ...
    <tr>
        ...
        <form action="add_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
            ...
            <p><b>Title TH *</b></p>
                ...
                <p><textarea name="description_th" cols="20" rows="10"  id="description_th" class="FCKeditor"></textarea>
                </p>
                <p><b>Title EN *</b></p>
                <p><input type="text" name="title_en" id="title_en" style="width:290px;" ></p>
                <p><b>Description EN *</b></p>
                <p><textarea name="description_en" cols="20" rows="10"  id="description_en" class="FCKeditor"></textarea>
                </p>
<!--            <p><b>Quater *</b></p>
            <p>
