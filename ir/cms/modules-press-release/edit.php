<? include "../../../ir/cms/modules-press-release/header.php"; ?>
    ...
    <tr>
        ...
        <div id="form-add-area" style="width:850px;">
            <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
                ...
                <p><b>Title TH *</b></p>
                <p><input type="text" name="title_th" id="title_th" style="width:600px;" value="<?=$arrDetail['title_th']?>"></p>
                <p><b>Description TH *</b></p>
                <p><textarea name="description_th" cols="20" rows="10"  id="description_th" class="FCKeditor">
                <?=stripslashes($arrDetail['description_th'])?>
                </textarea>
                </p>
                <p><b>Title EN *</b></p>
                <p><input type="text" name="title_en" id="title_en" style="width:600px;" value="<?=$arrDetail['title_en']?>"></p>
                <p><b>Description EN *</b></p>
                <p><textarea name="description_en" cols="20" rows="10"  id="description_en" class="FCKeditor">
                <?=stripslashes($arrDetail['description_en'])?>
                </textarea>
                </p>
                <p><b>Date *</b></p>
                <p><input type="text" name="create_date" id="datepicker" style="width:600px;" value="<?=$arrDetail['create_date']?>"></p>
<!--                <p><b>Quater *</b></p>
                <p>
                ...
                <p>
                    <?php if($arrDetail['file_th'] !=""){?>
                        <a href="../../../ir/uploads/press-release/<?=$arrDetail['file_th']?>" target="_blank"><?=$arrDetail['file_th']?></a>
                ...
                <p>
                    <?php if($arrDetail['file_en'] !=""){?>
                        <a href="../../../ir/uploads/press-release/<?=$arrDetail['file_en']?>" target="_blank"><?=$arrDetail['file_en']?></a>
                ...
                <input name="type_id" type="hidden" id="type_id" value="pr">
...
<? include "../../../ir/cms/modules-press-release/footer.php";?>
<script>
var ajax = new Array();
function deleteFile(id,file,type){
	var path = "../../../ir/uploads/press-release/";
