...
$condition= " WHERE configuration_id = '6' ";
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b>News Room &gt; Press Release</b></td>
    ...
    <tr>
        <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All <a href="index.php?perpage=<?=$_REQUEST["perpage"]?>">(<?php echo countIRDocumentConfigurationStatus('','6'); ?>) </a>| Active <a href="index.php?perpage=<?=$_REQUEST["perpage"]?>&actived=1">(<?php echo countIRDocumentConfigurationStatus('1','6'); ?>)</a> | inactive <a href="index.php?perpage=<?=$_REQUEST["perpage"]?>&actived=0">(<?php echo countIRDocumentConfigurationStatus('0','6'); ?>)</a></td>
                    ...
                    <li id="recordsArray_<?=$value[id]?>">
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr class="txt-content-11-black-2" bgcolor="<?=$cms_bgout?>" onMouseOver="this.style.backgroundColor='<?=$cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?=$cms_bgout?>'" >
                                ...
                                <td width="30%" valign="top" class="txt-content-11-black-2"><a href="../../../ir/uploads/press-release/<?=$value['file_th']?>"><?=$value['title_th']?></a></td>
                                <td width="30%" valign="top" class="txt-content-11-black-2"><a href="../../../ir/uploads/press-release/<?=$value['file_en']?>"><?=$value['title_en']?></a></td>
