...
<div id="center1">
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b><a href="../index.php" >Shareholder Information &gt; <a href="index.php">The Resolutions</a> > Edit</b></td>
...
<!--                <p><b>Quater *</b></p>
                ...
                <p>
                    <?php if($arrDetail['file_th'] !=""){?>
                        <a href="../../../ir/uploads/resolutions/<?php echo $arrDetail['file_th']?>" target="_blank"><?php echo $arrDetail['file_th']?></a>
                ...
                <p>
                    <?php if($arrDetail['file_en'] !=""){?>
                        <a href="../../../ir/uploads/resolutions/<?php echo $arrDetail['file_en']?>" target="_blank"><?php echo $arrDetail['file_en']?></a>
                ...
                <input name="type_id" type="hidden" id="type_id" value="rslt">
...
function deleteFile(id,file,type){
	var path = "../../../ir/uploads/resolutions/";
