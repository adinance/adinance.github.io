<? include "../../../ir/cms/modules-financial-statement/header.php"; ?>
<script>
...
<div id="center1">
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b><a href="../index.php" >Financecial Information &gt; <a href="index.php">Financial Statement</a> > Edit</b></td>
            ...
            <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
                ...
                <p>
                    <?php if($arrDetail['file_th'] !=""){?>
                        <a href="../../../ir/uploads/financial-statement/<?=$arrDetail['file_th']?>" target="_blank"><?=$arrDetail['file_th']?></a>
                ...
                <p>
                    <?php if($arrDetail['file_en'] !=""){?>
                        <a href="../../../ir/uploads/financial-statement/<?=$arrDetail['file_en']?>" target="_blank"><?=$arrDetail['file_en']?></a>
...
<? include "../../../ir/cms/modules-financial-statement/footer.php";?>
<script>
var ajax = new Array();
function deleteFile(id,file,type){
	var path = "../../../ir/uploads/financial-statement/";
