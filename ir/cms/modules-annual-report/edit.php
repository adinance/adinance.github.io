...
<!--                <p><b>Quater *</b></p>
                ...
                <p>
                    <?php if($arrDetail['file_th'] !=""){?>
                        <a href="../../../ir/uploads/annual-report/<?=$arrDetail['file_th']?>" target="_blank"><?=$arrDetail['file_th']?></a>
                ...
                <p>
                    <?php if($arrDetail['file_en'] !=""){?>
                        <a href="../../../ir/uploads/annual-report/<?=$arrDetail['file_en']?>" target="_blank"><?=$arrDetail['file_en']?></a>
...
function deleteFile(id,file,type){
	var path = "../../../ir/uploads/annual-report/";
