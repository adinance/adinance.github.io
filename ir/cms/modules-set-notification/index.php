<?php include "../../../ir/cms/modules-set-notification/header.php"; ?>
<script>
  $().ready(function () {
...
$condition= " WHERE configuration_id = '5' ";
...
$mList = getIRDocumentPagingList($condition ,$order,$startpoint,$perpage);
?>
<div id="center1">
    <?//=$mList?>
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b>News Room &gt; Set Notification</b></td>
        <td align="right" valign="top" class="txt-search-12-black" style="padding: 10px 20px 0px 20px"><b>Welcome : </b><?php echo $_SESSION["s_admin_username"]?></td>
    </tr>
    <tr>
        <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All <a href="index.php?perpage=<?php echo $_REQUEST["perpage"]?>">(<?php echo countIRDocumentConfigurationStatus('','5'); ?>) </a>| Active <a href="index.php?perpage=<?php echo $_REQUEST["perpage"]?>&actived=1">(<?php echo countIRDocumentConfigurationStatus('1','5'); ?>)</a> | inactive <a href="index.php?perpage=<?php echo $_REQUEST["perpage"]?>&actived=0">(<?php echo countIRDocumentConfigurationStatus('0','5'); ?>)</a></td>
    ...
    <tr>
        <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">
            <div style="float:left; width:160px;" id="search-area"> 
                ...
                <input name="keyword" type="text" class="form-search" id="keyword" style="height:20px;" value="<?php echo $_REQUEST["keyword"]?>">
                </form>
            </div>
        <div id="search-button" style="float:left;">search</div>
        </td>
      <td align="right" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">View : <a href="index.php?perpage=all&actived=<?php echo $_REQUEST["actived"]?>">All</a> | <a href="index.php?perpage=10&actived=<?php echo $_REQUEST["actived"]?>">10</a> | <a href="index.php?perpage=30&actived=<?php echo $_REQUEST["actived"]?>">30</a> | <a href="index.php?perpage=50&actived=<?php echo $_REQUEST["actived"]?>">50</a> per page</td>
    </tr>
  <tr>
      ...
      <form name="form1" method="post" action="delete_script.php" onSubmit="return confirm('Confirm to delete?'); ">
            <table width="100%"  border="0" cellspacing="0" cellpadding="0">
              <tr bgcolor="<?php echo $cms_bghead?>" >
                ...
                <td width="10%" class="txt-content-11-white-2">Create Date</td>
                ...
                <?php if($_SESSION["s_admin_rule1"] == 1){ ?>
                    <td width="5%" class="txt-content-11-white-2">Edit<input name="tid" type="hidden" id="tid" value="<?php echo $type_id?>"></td>
                    ...
                    <li id="recordsArray_<?php echo $value[id]?>">
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr class="txt-content-11-black-2" bgcolor="<?php echo $cms_bgout?>" onMouseOver="this.style.backgroundColor='<?php echo $cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?php echo $cms_bgout?>'" >
                                ...
                                <td width="30%" valign="top" class="txt-content-11-black-2"><a href="../../../ir/uploads/set-notification/<?php echo $value['file_th']?>"><?php echo $value['title_th']?></a></td>
                                <td width="30%" valign="top" class="txt-content-11-black-2"><a href="../../../ir/uploads/set-notification/<?php echo $value['file_en']?>"><?php echo $value['title_en']?></a></td>
                                <!--<td valign="top" class="txt-content-11-black-2"><?php echo $value['file_th']?></td>-->
                                <td width="10%" valign="top" class="txt-content-11-black-2"><?php echo $value['year']?></td>
                                <td width="10%" valign="top" class="txt-content-11-black-2"><?php echo $value['create_date']?></td>
                                <!--<td width="10%" valign="top" class="txt-content-11-black-2"><?php echo $value['type']?></td>-->
...
<?php include "../../../ir/cms/modules-set-notification/footer.php";?>
