...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b>News Room &gt; <a href="index.php">Set Notification</a> > Add New</b></td>
...
<!--            <p><b>Quater *</b></p>
            ...
            <p><b>Date</b></p>
            <p><input type="text" name="create_date" id="datepicker" ></p>
