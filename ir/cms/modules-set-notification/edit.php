...
<div id="center1">
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b><a href="../index.php" >News Room &gt; <a href="index.php">Set Notification</a> > Edit</b></td>
    ...
    <tr>
        ...
        <div id="form-add-area" style="width:850px;">
            <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
                ...
                <p><b>Title TH *</b></p>
                <p><input type="text" name="title_th" id="title_th" style="width:290px;" value="<?php echo $arrDetail['title_th']?>"></p>
                <p><b>Title EN *</b></p>
                <p><input type="text" name="title_en" id="title_en" style="width:290px;" value="<?php echo $arrDetail['title_en']?>"></p>
<!--                <p><b>Quater *</b></p>
                <p>
                ...
                <p>
                  <select name="year" class="form-user" id="year">
                    ...
                    <?php for($i=2010;$i<date("Y")+3;$i++){ ?>
                        <option value="<?php echo $i?>" <?php if($arrDetail[year]==$i){?> selected <?php }?> ><?php echo $i?></option>
                    <?php } ?>
                  </select>
                </p>
                <p><b>Date</b></p>
            <p><input type="text" name="create_date" id="datepicker" value="<?php echo $arrDetail['create_date']?>" ></p>
                ...
                <p>
                    <?php if($arrDetail['file_th'] !=""){ ?>
                        <a href="../../../ir/uploads/set-notification/<?php echo $arrDetail['file_th']?>" target="_blank"><?php echo $arrDetail['file_th']?></a>
                        <img src="../images/icon/b_icon_trash.gif" width="12" height="13" onclick="deleteFile('<?php echo $id?>','<?php echo $arrDetail['file_th']?>','1')" >
                    <?php } else{ ?>
                        No file 
                    <?php } ?>
                    <input name="file_th" type="hidden" id="file_th" value="<?php echo $arrDetail['file_th']?>">
                </p>
                <p><input type="file" name="file_th" id="file_th"></p>
                <p><b>File EN * (.pdf / .zip)</b></p>
                <p>
                    <?php if($arrDetail['file_en'] !=""){?>
                        <a href="../../../ir/uploads/set-notification/<?php echo $arrDetail['file_en']?>" target="_blank"><?php echo $arrDetail['file_en']?></a>
                        <img src="../images/icon/b_icon_trash.gif" width="12" height="13" onclick="deleteFile('<?php echo $id?>','<?php echo $arrDetail['file_en']?>','1')" >
                    <?php } else{ ?>
                        No file 
                    <?php } ?>
                    <input name="file_en" type="hidden" id="file_en" value="<?php echo $arrDetail['file_en']?>">
                </p>
                ...
                <input name="type_id" type="hidden" id="type_id" value="sn">
...
function deleteFile(id,file,type){
	var path = "../../../ir/uploads/set-notification/";
