...
// Call getIRNewslist
$arrList = getIRNewsList($cond ,$order,$startpoint,$perpage);
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> &gt; Investor News</b>
      </td>
    ...
    <tr>
      <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All (<?php echo sumIRNews(''); ?>) | Active (<?php echo sumIRNews('1'); ?>) | inactive (<?php echo sumIRNews('2'); ?>)</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" class="txt-content-11-black" style="padding: 20px">
		...
		?>
         <li id="recordsArray_<?=$value[id]?>">
          ...
          <tr class="txt-content-11-black-2" bgcolor="<?=$cms_bgout?>" onMouseOver="this.style.backgroundColor='<?=$cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?=$cms_bgout?>'" >
            ...
            <?php if($value[pdf] !=""){ ?>
            <a href="../../data/irfile/news/pdf/<?=$value[pdf]?>" target="_blank">view</a>
            <?php }else{ ?>
             -
            <?php } ?>
            </td>
      ...
      <br><br>
      <?php echo Pages("main_ir_news",$perpage,"index.php?perpage=$perpage&",$cond); ?>
      </td>
  </tr>
  </table>	   
</div>
