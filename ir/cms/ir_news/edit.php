...
$arrDetail = getIRNewsDetail(" WHERE id = '$id' ");
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> :  Financecial Information -&gt; <a href="index.php">Investor News</a> -> Edit</b>
      </td>
  ...
  <tr>
    ...
    <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     ...
     <p>
      ...
      <p>
        <input name="title" type="text" class="form-user" id="title" value="<?=stripslashes($arrDetail[title])?>">
      </p>
