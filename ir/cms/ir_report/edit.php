...
$arrDetail = getReportDetail(" WHERE id = '$id' ");
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> :  Investor Relations-> <a href="index.php">Annual Report</a> -> Edit</b>
      </td>
  ...
  <tr>
    ...
    <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     ...
     <p>
      ...
      <p><b>Photo ( 152 X 132 px)</b></p>
      <p><img src="../../data/irfile/report/photo/<?=$arrDetail[photo]?>">
        <input name="old_photo" type="hidden" id="old_photo" value="<?=$arrDetail[photo]?>">
      </p>
      <p><input type="file" name="photo" id="photo"></p>
      
      <p><b>PDF File</b></p>
      <p><a href="../../data/irfile/report/pdf/<?=$arrDetail[pdf]?>" target="_blank"><?=$arrDetail[pdf]?></a>
