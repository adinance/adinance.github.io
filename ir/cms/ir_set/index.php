...
// Call getIRNewslist
$arrList = getIRSETList($cond ,$order,$startpoint,$perpage);
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : Financecial Information -&gt; SET Information</b>
      </td>
    ...
    <tr>
      <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All (<?php echo sumIRSET(''); ?>) | Active (<?php echo sumIRSET('1'); ?>) | inactive (<?php echo sumIRSET('2'); ?>)</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" class="txt-content-11-black" style="padding: 20px">
      <form name="form1" method="post" action="delete_script.php" onSubmit="return confirm('Confirm to delete?'); ">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr bgcolor="<?=$cms_bghead?>" >
            ...
            <td width="60%" class="txt-content-11-white-2">Title</td>
		...
		?>
         <li id="recordsArray_<?=$value[id]?>">
          ...
          <tr class="txt-content-11-black-2" bgcolor="<?=$cms_bgout?>" onMouseOver="this.style.backgroundColor='<?=$cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?=$cms_bgout?>'" >
            ...
            <td width="60%" valign="top" class="txt-content-11-black-2">
            <?=stripslashes($value[title])?>
            </td>
            <td  valign="top" class="txt-content-11-black-2">
            <?php if($value[pdf] !=""){ ?>
            <a href="../../data/irfile/set/pdf/<?=$value[pdf]?>" target="_blank">view</a>
            <?php }else{ ?>
             -
            <?php } ?>
            </td>
      ...
      <br><br>
      <?php echo Pages("main_ir_set",$perpage,"index.php?perpage=$perpage&",$cond); ?>
      </td>
  </tr>
  </table>	   
</div>
