...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : Financecial Information -&gt; <a href="index.php">SET Information</a> -> Add New</b>
      </td>
  ...
  <tr>
    ...
    <form action="add_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     <p style="font-weight:bold; border-bottom:1px solid #666;">* Required field</p>
      ...
      <p>
        <input name="title" type="text" class="form-user" id="title" value="">
      </p>
