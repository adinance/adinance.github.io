...
$arrDetail = getPresentationDetail(" WHERE id = '$id' ");
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> :  Investor Relations-> <a href="index.php">Presentation</a> -> Edit</b>
      </td>
  ...
  <tr>
    ...
    <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     ...
     <p>
      ...
      <p><b>Presention ( youtube Video ID Ex.http://www.youtube.com/watch?v=<span class="ui-state-error">KsOtbbGzm84</span>)</b></p>
      <p><input name="presentation" type="text" class="form-input" id="presentation" value="<?=stripslashes($arrDetail[presentation])?>">
      </p>
      
      
      <p><b>Webcast ( youtube Video ID Ex.http://www.youtube.com/watch?v=<span class="ui-state-error">KsOtbbGzm84</span> )</b></p>
      <p><input name="webcast" type="text" class="form-input" id="presentation" value="<?=stripslashes($arrDetail[webcast])?>"></p>
