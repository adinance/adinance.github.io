...
// Call getPresentationlist
$mList = getPresentationList($cond ,$order,$startpoint,$perpage);
?>
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : Investor Retations -&gt; Presentation</b>
      </td>
    ...
    <tr>
      <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All (<?php echo sumPresentation(''); ?>) | Active (<?php echo sumPresentation('1'); ?>) | inactive (<?php echo sumPresentation('2'); ?>)</td>
  ...
  <tr>
    <td colspan="2" align="left" valign="top" class="txt-content-11-black" style="padding: 20px">
      <form name="form1" method="post" action="delete_script.php" onSubmit="return confirm('Confirm to delete?'); ">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr bgcolor="<?=$cms_bghead?>" >
            ...
            <td width="20%" class="txt-content-11-white-2">Presentation</td>
            <td  class="txt-content-11-white-2">Webcast</td>
		...
		?>
         <li id="recordsArray_<?=$value[id]?>">
          ...
          <tr class="txt-content-11-black-2" bgcolor="<?=$cms_bgout?>" onMouseOver="this.style.backgroundColor='<?=$cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?=$cms_bgout?>'" >
			...
			<iframe class="youtube-player" type="text/html" width="200" height="140" src="http://www.youtube.com/embed/<?=stripslashes($value[presentation])?>" frameborder="0">
</iframe>
            </td>
            <td valign="top" class="txt-content-11-black-2">
			<iframe class="youtube-player" type="text/html" width="200" height="140" src="http://www.youtube.com/embed/<?=stripslashes($value[webcast])?>" frameborder="0">
</iframe>
            </td>
      ...
      <br><br>
      <?php echo Pages("main_presentation",$perpage,"index.php?perpage=$perpage&",$cond); ?>
      </td>
  </tr>
  </table>	   
</div>
