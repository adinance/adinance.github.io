...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
   <tr>
      ...
      <b><a href="../index.php" >Home</a> : Investor Relations-> <a href="index.php">Presentation</a> -> Add New</b>
      </td>
  ...
  <tr>
    ...
    <form action="add_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
     <p style="font-weight:bold; border-bottom:1px solid #666;">* Required field</p>
      ...
      <p><b>Presentation ( youtube Video ID Ex.http://www.youtube.com/watch?v=<span class="ui-state-error">KsOtbbGzm84</span> )</b> </p>
      <p><input name="presentation" id="presentation" type="text" class="form-input"></p>
      <p><b>Webcast ( youtube Video ID Ex.http://www.youtube.com/watch?v=<span class="ui-state-error">KsOtbbGzm84</span> )</b></p>
      <p><input name="webcast" id="webcast" type="text" class="form-input"></p>
