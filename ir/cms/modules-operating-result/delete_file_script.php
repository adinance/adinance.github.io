...
//switch($type){
//	case "q1" :$file_th=""; break;
//	case "q2" :$file_en=""; break;
//	case "q3" :$title_th=""; break;
//	case "q4" :$title_en=""; break;
//}

//editStatement($id,$type_id,$year,$pdf1,$pdf2,$pdf3,$pdf4,$status);
$update_by = $_SERVER['REMOTE_ADDR'];
$url_th = $arr['url_th'];
$url_en = $arr['url_en'];
