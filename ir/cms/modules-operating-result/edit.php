...
$arrDetail = getIRDocumentRecord(" WHERE id = '$id' and type in ('q1','q2','q3','q4') ");
?>
<div id="center1">
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b><a href="../index.php" >Financecial Information &gt; <a href="index.php">Operating Result</a> > Edit</b></td>
    ...
    <tr>
        ...
        <div id="form-add-area" style="width:850px;">
            <form action="edit_script.php" method="post" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
                <p style="font-weight:bold; border-bottom:1px solid #666;">* Required field <?=$arrDetail['type'].' / '.$arrDetail['year']?></p>
                <p><b>Title TH *</b></p>
                ...
                <p>
                    <?php if($arrDetail['file_th'] !=""){?>
                        <a href="../../../ir/uploads/operating-result/<?=$arrDetail['file_th']?>" target="_blank"><?=$arrDetail['file_th']?></a>
                ...
                <p>
                    <?php if($arrDetail['file_en'] !=""){?>
                        <a href="../../../ir/uploads/operating-result/<?=$arrDetail['file_en']?>" target="_blank"><?=$arrDetail['file_en']?></a>
...
function deleteFile(id,file,type){
	var path = "../../../ir/uploads/operating-result/";
