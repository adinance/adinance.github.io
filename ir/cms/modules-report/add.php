...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b>Shareholder Information &gt; <a href="index.php">The minutes of Annual General Meeting</a> > Add New</b></td>
    ...
    <tr>
        ...
        <form action="add_script.php" method="get" enctype="multipart/form-data" name="frmAdd" class="form-add"  id="frmAdd" >
