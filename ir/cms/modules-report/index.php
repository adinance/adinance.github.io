<?php include "../../../ir/cms/modules-report/header.php"; ?>
<script>
  $().ready(function () {
...
$order = " year desc , type desc";
if(isset($_GET["order"]) && ($_GET["order"] !="")){
$order .= " , ".$_GET["order"];
}
$condition= " WHERE configuration_id = '10' ";
...
<div id="center1">
  ...
  <table width="95%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
        <td align="left" valign="top" class="txt-content-12-black"  style="padding: 10px 20px 0px 20px"><b>Shareholder Information &gt; The minutes of Annual General Meeting</b></td>
    ...
    <tr>
        <td align="left" valign="top" class="txt-content-11-black" style="padding: 10px 20px 0px 20px">All <a href="index.php?perpage=<?php echo $_REQUEST["perpage"]?>">(<?php echo countIRDocumentConfigurationStatus('','10'); ?>) </a>| Active <a href="index.php?perpage=<?php echo $_REQUEST["perpage"]?>&actived=1">(<?php echo countIRDocumentConfigurationStatus('1','10'); ?>)</a> | inactive <a href="index.php?perpage=<?php echo $_REQUEST["perpage"]?>&actived=0">(<?php echo countIRDocumentConfigurationStatus('0','10'); ?>)</a></td>
                    ...
                    <li id="recordsArray_<?php echo $value[id]?>">
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            <tr class="txt-content-11-black-2" bgcolor="<?php echo $cms_bgout?>" onMouseOver="this.style.backgroundColor='<?php echo $cms_bgover?>';" onMouseOut="this.style.backgroundColor='<?php echo $cms_bgout?>'" >
                                ...
                                <td width="30%" valign="top" class="txt-content-11-black-2"><a href="../../../ir/uploads/report/<?php echo $value['file_th']?>"><?php echo $value['title_th']?></a></td>
                                <td width="30%" valign="top" class="txt-content-11-black-2"><a href="../../../ir/uploads/report/<?php echo $value['file_en']?>"><?php echo $value['title_en']?></a></td>
...
<?php include "../../../ir/cms/modules-report/footer.php";?>
