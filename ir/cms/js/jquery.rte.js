...
lwRTE.prototype.enable_design_mode = function() {
	...
	for(var i in self.css)
		...
		//css += "<link type='text/css' rel='stylesheet' href='rte.css' />";
	...
	//var doc = "<html><head>" + base + css + "</head><body   style='font-family:tahoma;font-size:9px;padding:5px'>" + content + "</body></html>";
