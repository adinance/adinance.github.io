(function (a) {
                        ...
                        if (c && /youtu\.?be/g.test(c[3]))
                            (b = "http" + ("https:" === location.protocol ? "s" : "") + ":"),
                                ...
                                a("<img>")
                                    ...
                                    .attr("src", b),
                                !a.fn.YTPlayer || f || a.isMobile() || a("> *:eq(1)", this).before('<div class="mbr-background-video"></div>').prev().YTPlayer({ videoURL: c[6], containment: "self", showControls: !1, mute: !0 });
                        else {
        ...
        a(".cols-same-height .mbr-figure").each(function () {
            function b() {
                ...
                if (f && h) {
                    ...
                    g > a && ((a = (100 * (g - a)) / a), d.css({ width: a + 100 + "%", maxWidth: a + 100 + "%", marginLeft: -a / 2 + "%" }));
                }
            }
            var c = a(this),
                d = c.children("img"),
    ...
    f ||
        ...
        "undefined" === typeof window.initTabsPlugin && ((window.initTabsPlugin = !0), r(document.body)),
