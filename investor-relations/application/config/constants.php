...
define('SEO_OG_URL','https://ir.cmo-group.com');
define('SEO_OG_TYPE','website');
define('SEO_OG_IMAGE','assets/img/og_image.webp');
define('SEO_OG_TITLE','Investor Relations');
define('SEO_OG_DESCRIPTION','');

// URL
define('URL_SOCIAL_FACEBOOK','https://www.facebook.com/CMOGroupTH/');
define('URL_SOCIAL_INSTAGRAM','https://www.instagram.com/cmogroupth/');
define('URL_SOCIAL_X','https://twitter.com/CMOGroupTH');
define('URL_SOCIAL_TIKTOK','https://www.tiktok.com/@cmogroupth');
define('URL_SOCIAL_THREADS','https://www.threads.net/@cmogroupth');
define('URL_SOCIAL_YOUTUBE','https://www.youtube.com/@cmo-group');
