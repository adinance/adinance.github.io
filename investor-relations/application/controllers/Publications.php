...
class Publications extends CI_Controller {
    ...
    public function annual_report() {
        ...
        isset($this->session->form_56_1) ? $this->data['menu_right'] = $this->session->form_56_1 : $this->data['menu_right'] = 'Form 56-1';
    ...
    public function presentations_and_webcasts() {
        ...
        isset($this->session->form_56_1) ? $this->data['menu_left']         = $this->session->form_56_1 : $this->data['menu_left']         = 'Form 56-1';
        $this->data['menu_left_url']                                            = BASE_URL . $this->utilities->method_to_link('form_56_1');
    ...
    public function presentations_and_webcasts_dev() {
    ...
    public function form_56_1() {
        ...
        isset($this->session->form_56_1) ? $this->data['menu'] = $this->session->form_56_1 : $this->data['menu'] = 'Form 56-1';
