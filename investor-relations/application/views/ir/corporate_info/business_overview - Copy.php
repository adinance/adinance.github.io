...
<section class="BsO-Container">
  ...
  <div class="d-flex Bso-SubHead upper">
	...
	<div class="col Bso-SubHeadList Bso-SubHead3 text-center centered"><a href="#BsO-03" style="color: white;">Digital Content Agency</a></div>
	...
	<div class="col Bso-SubHeadList Bso-SubHead5 text-center centered"><a href="#BsO-05" style="color: white;">Museum Creator</a></div>
...
<div class=" BsO7 text-center" id="BsO-03">
	<h2 class="align-center pb-3 mbr-fonts-style display-2 upper">Digital Content Agency</h2>
	<p class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5">We are a digital marketing service provider focused on comprehensive digital marketing management,
brand experience design, and multimedia production, covering both online and offline marketing,
operating under Nerve Creative Co., Ltd. (&#39;Nerve&#39;).</p> 
	<div class=" sub-BsO7 justify-content-center" >
		<div class=" sub-BsO7List" ><img src="<?php echo BASE_URL; ?>assets/img/business-overview/video-cinema-production.jpg">
			<h5 class="align-center pb-3 mbr-fonts-style display-2 upper" style="text-align: center; line-height: normal;" ><strong>Digital Marketing</strong></h5>	
			<!-- <p >  
				Video & Cinema Production: one-stop service of video production from creative & script development, shooting production, computer graphic development, sound recording and mixing and video editing. Our types of video production ranges from corporate video, promotional video, product.
			</p>  -->
			<p class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5" style="text-align: left;">
		• Market Research
         ...
         <br>• Web Design, Coding and Application
</p>
		</div>
		<div class=" sub-BsO7List" >
			<img src="<?php echo BASE_URL; ?>assets/img/business-overview/interactive-media.jpg">
			<h5 class="align-center pb-3 mbr-fonts-style display-2 upper" style="text-align: center; line-height: normal;"><strong>Multimedia Production</strong></h5>	
			<p class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5" style="text-align: left;">
			• Interactive Media/ Display Media
<br>• Immersive Projection Mapping/
<br>• Hologram
<br>• Metaverse/ VR/ AR/ XR
<br>• Hyper Realistic Ads/ CGI/ VFX
<br>• Program & Application Development	
</p>
		</div>
		<div class=" sub-BsO7List" ><img src="<?php echo BASE_URL; ?>assets/img/business-overview/video-film-production.jpg">
			<!-- <h5>Multimedia</h5> -->
			<h5 class="align-center pb-3 mbr-fonts-style display-2 upper" style="text-align: center; line-height: normal;"><strong>Video & Film Production</strong></h5>	
			<p class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5" style="text-align: left;">
			• Pre-Production/ Production/ <br>Post-production
			<br>• 2D & 3D Animation/ Motion Graphic/
			<br>• Unreal Engine
</p>
</div>
		<div class=" sub-BsO7List" ><img src="<?php echo BASE_URL; ?>assets/img/business-overview/multimedia.jpg">
			<h5 class="align-center pb-3 mbr-fonts-style display-2 upper" style="text-align: center; line-height: normal;"><strong>Creative Brand Experience Design</strong></h5>	
			<p class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5" style="text-align: left;">
			• IP Event , IP Attraction
<br>• Event Online
...
<!-- 
	<div class="BsO9" id="BsO-06">
		<div class="col-md-4  p-3 BsO4List">
			<h2 class="align-center pb-3 mbr-fonts-style display-2 upper">Utility Service</h2>
			<p class="mbr-section-subtitle align-center mbr-light mbr-fonts-style display-5" >Utilities Service is operated under Exposition Technology Company Limited (Abbreviation as Expo Tech)
which is a subsidiary that the Company is a shareholder holding 40% of the paid registered capital.
Expo Tech is a provider of utility service systems such as electrical connecting system, water piping
system, air duct system and signal wiring system that are essential to event organizing. Furthermore, Expo
Tech is the official operator of utility service for the Challenger Hall of Muang Thong Thani.
			</p>
		</div>
		<div class="col-md-4  p-3 BsO4List "><img src="<?php echo BASE_URL; ?>assets/img/BO-img/business overview-creative 05.jpg"></div>
	  </div>
...
<section class="extHeader cid-us6nVjE4rq" id="extHeader23-mm">
    ...
    <div class="animated-text-background display-5" style="color: rgb(66, 132, 223); opacity: 0.2; font-size: 13rem;">
        <span class="animated-element" data-word="Utility Service" data-speed="50">
        </span>
    </div>
    <div class="container">
