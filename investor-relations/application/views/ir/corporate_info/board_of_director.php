	...
	<div class="container align-center">
		<div class="row media-row">
			<div class="team-item col-lg-3 col-md-6">
				...
				<div class="item-caption py-3">
					<div class="item-name px-2">
						<p class="mbr-fonts-style display-4"><strong>Mr. Tatchapong Thamputthipong</strong></p>
					</div>
			...
			<div class="team-item col-lg-3 col-md-6">
				...
				<div class="item-caption py-3">
					<div class="item-name px-2">
						<p class="mbr-fonts-style display-4"><strong>Mr. Sujarit Isarankura</strong></p>
					</div>
					<div class="item-role px-2 display-4">
						<p class="display-4" style="font-size: 0.9em !important; padding-top:10px;">• Chairman of the Audit Committee
			...
			<div class="team-item col-lg-3 col-md-6">
				...
				<div class="item-caption py-3">
					<div class="item-name px-2">
						<p class="mbr-fonts-style display-4"><strong>Mr. Noppadol Utain
							</strong></p>
					</div>
					<div class="item-role px-2 display-4">
		...
		<div class="row media-row">
			...
			<div class="team-item col-lg-3 col-md-6">
				...
				<div class="item-caption py-3">
					<div class="item-name px-2">
						<p class="mbr-fonts-style display-4"><strong>
								Ms. Naphamat Phlaingam</strong></p>
					</div>
					<div class="item-role px-2 display-4">
						<p class="display-4" style="font-size: 0.9em !important; padding-top:10px;">
...
<!-- <section class="cid-upzYy89jmz" id="board-of-director-trairong">
	<div class="hovershine">
		<figure class="mbr-figure">
			<div class="image-block fadein" style="width: 66%;">
				<img src="<?php echo BASE_URL . PATH_MOBIRISE ; ?>assets/images/board-of-director-info-k-yingrak-1920x1503.jpg" width="1400"
					>
			</div>
		</figure>
	</div>
