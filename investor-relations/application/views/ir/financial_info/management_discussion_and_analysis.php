          ...
          <tbody>
            ...
            <tr>
              <td class="body-item mbr-fonts-style display-7 align-center">
                <strong><?php if($this->session->userdata('lang')=='thai'){ echo $result['year'][$i]->year + 543 ; }else{ echo $result['year'][$i]->year; }?></strong></td>
              <td class="body-item mbr-fonts-style display-7">
                <?php if($result['record'][$result['year'][$i]->year]['Q1']['file'] != ''){?>
                <a target="_blank"
                  href="<?php echo BASE_URL_UPLOAD . 'operating-result/' . $result['record'][$result['year'][$i]->year]['Q1']['file']; ?>"
              ...
              <td class="body-item mbr-fonts-style display-7">
                ...
                <a target="_blank"
                  href="<?php echo BASE_URL_UPLOAD . 'operating-result/' . $result['record'][$result['year'][$i]->year]['Q2']['file']; ?>"
                  class="fa fa-download mbr-iconfont" style="color: rgb(54, 123, 186);"></a>
                <?php } ?>
              </td>
              <td class="body-item mbr-fonts-style display-7">
                ...
                <a target="_blank"
                  href="<?php echo BASE_URL_UPLOAD . 'operating-result/' . $result['record'][$result['year'][$i]->year]['Q3']['file']; ?>"
                  class="fa fa-download mbr-iconfont" style="color: rgb(54, 123, 186);"></a>
                <?php } ?>
              </td>
              <td class="body-item mbr-fonts-style display-7">
                ...
                <a target="_blank"
                  href="<?php echo BASE_URL_UPLOAD . 'operating-result/' . $result['record'][$result['year'][$i]->year]['Q4']['file']; ?>"
                  class="fa fa-download mbr-iconfont" style="color: rgb(54, 123, 186);"></a>
                <?php } ?>
              </td>
            </tr>
