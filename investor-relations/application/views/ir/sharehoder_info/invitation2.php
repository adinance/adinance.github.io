...
<body>
        <section>
                ...
                <div class="container">
                    <div class="row">
                        <div  class="col-md-4 menu"><a href="invitation" style="text-decoration-line: none;color:#2f61b6;text-align:center;">INVITATION</a></div>
                        <div class="col-md-4 menu"><a href="resolutions" style="text-decoration-line: none;color:#cccccc;">THE RESOLUTIONS</a></div>
                        <div class="col-md-4 menu"><a href="the-minutes-of-annaul-general-meeting" style="text-decoration-line: none;color:#cccccc;">THE MINUTE OF <br>ANNUAL GENERAL MEETING</a></div>
                        <!-- <h2 class="left-and-right"></h2> -->
                    </div>
                    <div class="row">
                        <div class="col-md-12" style="text-align:center;"><h3>INVITATION</h3>
                        </div>
                    </div>
