...
echo '<h3 class="tit">CMO Members</h3>';
$search = ''; 
$likeSearch = '';
$accessStatus = '';
$accessRoles = '';
...
echo '<td><select class="input-text" name="cmo_access_status" title="filter status account" >';
...
echo '<td><select class="input-text" name="cmo_access_efa" title="filter roles to access tools " >';
